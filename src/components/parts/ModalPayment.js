    ...
    <>
      <Modal isOpen={open} toggle={toggle} centered={true} size="lg">
        <ModalHeader toggle={toggle}>
          {/* // TODO Traducir acá */}
          <span className="text-primary bold">Detalle comprobante de pago</span>
        </ModalHeader>
        <ModalBody>
          <>
            <div className="row">
            ...
            <div className="row">
              <div className="col-12">
                ...
                <textarea
                  ...
                  rows="2"
                  placeholder={'No existe descripción ingresada'}
                  name="desc"
        ...
        <ModalFooter>
          <Button color="primary" onClick={toggle}>
            {/* //TODO Traducir esto */}
            <i className="pr-3 fas fa-envelope text-white"></i>
